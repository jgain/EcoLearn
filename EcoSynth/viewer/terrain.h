...
public:
    ...
    void setBufferToDirty(){ bufferState = BufferState::DIRTY; }

    void setAccelInValid(){ accelValid = false; }
    ...
    /**
       * Load a terrain from a file.
       * @param filename   File to load (16-bit PNG image format)
       * @see @ref MemMap for exception information
       */
    void loadPng(const uts::string &filename);
    /**
